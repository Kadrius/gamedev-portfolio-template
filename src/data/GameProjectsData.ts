...
export default [
    new ProjectData("project-1", "3D Wind Training", "img/projects/3DWindTraining-Header.jpg", 
    `
    <div class="paragraph">
     ...
     <br/>My role on the project was as lead (and only) developer. I designed and coded all the functionalities, from the library that contains the Training System to the design and deployment of the CMS and the communication logic with the app.<br/>
     This project was highly valued by the client and it helped establishing them as one of our main clients. For more info you can visit: <a href="https://catalogo.texascontrols.com/?page_id=4119">https://catalogo.texascontrols.com/?page_id=4119<a/>  
    </div>
    ...
    `, "#23bd69", true),
    new ProjectData("project-7", "7 Cidades - Patrones", "img/projects/7Cidades/cap_Patrones_Header.JPG", `
        <div class="paragraph">
    ...
    new ProjectData("project-2", "La Pinta VR", "img/projects/LaPinta/carabelaLaPintaHeader.png", `
    <div class="paragraph">
    ...
    `, "#5a78af", true),
    new ProjectData("project-3", "AR Plumbing Configurator", "img/projects/ABN/cap_ABN_Header.png", `
    <div class="paragraph">
    ...
    `, "#383838", true),
    new ProjectData("project-4", "Aquis Querquennis", "img/projects/Aquis/cap_Aquis_Header.jpg", `
    <div class="paragraph">
    ...
    `, "#e80fb7", true),
    new ProjectData("project-6", "Timetrip Narahío", "img/projects/Naraio/cap_Naraio_Header.png", `
        <div class="paragraph">
    ...
    new ProjectData("project-5", "XTAS", "img/projects/XTAS/cap_XTAS_Header.png", `
    <div class="paragraph">
